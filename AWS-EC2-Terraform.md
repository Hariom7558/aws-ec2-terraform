...
##Created main.tf to provision EC2:
...
Key points: Terraform manages only resources defined in .tf files.


##Observations / Lessons Learned

Terraform is declarative: it ensures the current infrastructure matches the .tf configuration.

Imported resources not in .tf will be destroyed on terraform apply.
